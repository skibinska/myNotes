...
Notes.prototype = {
    ...
    _showCollection: function () {
        for (var noteKey in this.collection.data) {
            var note = this.collection.data[noteKey];
    ...
    _showNote: function (note) {
        this.notesContainer.innerHTML += this._createNoteHtml(note);
    },
    ...
    _addCreateNoteEventHandler: function (button) {
        ...
        this.notesContainer.innerHTML += this._createNoteHtml(emptyNode);
        this._addEditAndDeleteEvents();
    },
